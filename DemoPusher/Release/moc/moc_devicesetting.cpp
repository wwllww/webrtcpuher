...
QT_MOC_LITERAL(3, 37, 25), // "on_micVolume_valueChanged"
QT_MOC_LITERAL(4, 63, 5), // "value"
QT_MOC_LITERAL(5, 69, 22), // "on_videoSource_clicked"
QT_MOC_LITERAL(6, 92, 7), // "checked"
QT_MOC_LITERAL(7, 100, 22), // "on_audioSource_clicked"
QT_MOC_LITERAL(8, 123, 29) // "on_playoutVolume_valueChanged"

    },
    "DeviceSetting\0on_buttonBox_accepted\0"
    "\0on_micVolume_valueChanged\0value\0"
    "on_videoSource_clicked\0checked\0"
    "on_audioSource_clicked\0"
    "on_playoutVolume_valueChanged"
};
...
void DeviceSetting::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->on_micVolume_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->on_videoSource_clicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 3: _t->on_audioSource_clicked((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 4: _t->on_playoutVolume_valueChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
    }
}
